...
String FWversion = "R3"; // 16 MHz crystal
#define ZERO 258  // 5th channel is channel 1 (column 10 from 0, ussually DCoffset or DCoffset+1)
#define TIMERESET 7560 // 21 hours
